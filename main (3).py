...
class BankAccount:
  ...
  def deposit(self, amount):
    if amount > 0:
      ...
      #self.__amount_balance = self.__account_balance+amount
      print("Deosited ₹{}. New balance: ₹{}".format(amount,
  ...
  def withdraw(self, amount):
    if amount > 0 and amount <= self.__account_balance:
      self.__account_balance -= amount
      #self.__amount_balance =    self.__ account_balance+amount
